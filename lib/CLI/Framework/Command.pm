...
sub dispatch {
    ...
    # @args was passed as a reference here, to workaround a nasty bug
    # somewhere. Without this, if a subcommand takes, eg. an array of
    # strings in parameters ('option=s@' in Getopt::Long::Descriptive),
    # Perl dies with the following message if the subcommand throws an
    # exception:
    #   Bizarre copy of ARRAY in aassign at /.../Devel/StackTrace.pm line 53
    # with Devel::StackTrace 1.26.
    #
    # The behaviour is explained in this mail:
    #   http://www.nntp.perl.org/group/perl.perl5.porters/2009/02/msg144174.html
    #
    # CLI::Framework::Application->run was changed too for the same reason.
    #
    # Other functions below takes @args in argument. This could lead to
    # the same bug, but:
    #     1. I don't know how to reproduce the bug
    #     2. I try to keep the diff as small as possible
    my @args = @$args;
